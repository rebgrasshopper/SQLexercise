...
set 
    ...
    TheMonth = DATE_FORMAT(TheDate, '%m'),
    TheMonthName = DATE_FORMAT(TheDate, '%M'),
    TheDay = DATE_FORMAT(TheDate, '%d'),
    TheDayOfWeek = DATE_FORMAT(TheDate, '%w'),
    TheDayOfWeekName = DATE_FORMAT(TheDate, '%W'),
    YYYYQQ = CONCAT(YEAR(TheDate), CASE
	WHEN DATE_FORMAT(TheDate, '%m') BETWEEN 1 AND 3 THEN 'Q1'
    WHEN DATE_FORMAT(TheDate, '%m') BETWEEN 4 AND 6  THEN 'Q2'
    WHEN DATE_FORMAT(TheDate, '%m') BETWEEN 7 AND 9  THEN 'Q3'
    WHEN DATE_FORMAT(TheDate, '%m') BETWEEN 10 AND 12  THEN 'Q4'
    END);
;
